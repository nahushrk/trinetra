...
function loadPage(page) {
    ...
    // Make API call
    const url = `/api/gcode_files?page=${page}&per_page=15&filter=${encodeURIComponent(filterText)}&sort_by=${encodeURIComponent(sortBy)}&sort_order=${encodeURIComponent(sortOrder)}`;
